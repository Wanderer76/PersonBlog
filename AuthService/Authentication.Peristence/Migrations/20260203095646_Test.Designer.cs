            ...
            modelBuilder.Entity("Authentication.Domain.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 2, 3, 9, 56, 46, 276, DateTimeKind.Unspecified).AddTicks(5968), new TimeSpan(0, 0, 0, 0, 0)),
                            LastAuthenticate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Login = "admin",
                            Password = "Qw9gP6bGfFQ=;iNNBDPwDvtSbWmEPhcEaPhdgcPxnf8t1907TMsM5suQ="
                        });
                });
