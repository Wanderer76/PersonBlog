...
namespace Profile.Persistence.Migrations
{
    ...
    [Migration("20250408062108_RemoveProfile")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.Domain.Entities.PersonBlog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 4, 8, 6, 21, 7, 552, DateTimeKind.Unspecified).AddTicks(5772), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Blog.Domain.Entities.ProfileEventMessages", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Blog.Domain.Entities.ProfileSubscription", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Blog.Domain.Entities.SubscriptionLevel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Blog.Domain.Entities.Post", b =>
                {
                    ...
                    b.HasOne("Blog.Domain.Entities.SubscriptionLevel", "Subscription")
                        .WithMany()
            ...
            modelBuilder.Entity("Blog.Domain.Entities.ProfileSubscription", b =>
                {
                    b.HasOne("Blog.Domain.Entities.SubscriptionLevel", "SubscriptionLevel")
                        .WithMany()
            ...
            modelBuilder.Entity("Blog.Domain.Entities.SubscriptionLevel", b =>
                {
                    b.HasOne("Blog.Domain.Entities.SubscriptionLevel", "NextSubscriptionLevel")
                        .WithMany()
