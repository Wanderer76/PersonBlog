...
namespace Profile.Persistence.Migrations
{
    ...
    [Migration("20250429092735_AddCreatedAt")]
            ...
            modelBuilder.Entity("Blog.Domain.Entities.PersonBlog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 4, 29, 9, 27, 32, 936, DateTimeKind.Unspecified).AddTicks(6986), new TimeSpan(0, 0, 0, 0, 0)),
