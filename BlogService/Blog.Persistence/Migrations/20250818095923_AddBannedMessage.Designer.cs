...
namespace Profile.Persistence.Migrations
{
    ...
    [Migration("20250818095923_AddBannedMessage")]
    partial class AddBannedMessage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Blog.Domain.Entities.PersonBlog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 8, 18, 9, 59, 22, 754, DateTimeKind.Unspecified).AddTicks(6925), new TimeSpan(0, 0, 0, 0, 0)),
