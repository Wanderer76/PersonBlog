...
namespace Profile.Persistence.Migrations
{
    ...
    [Migration("20250110045009_AddPreview")]
            ...
            modelBuilder.Entity("Profile.Domain.Entities.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 1, 10, 4, 50, 7, 556, DateTimeKind.Unspecified).AddTicks(151), new TimeSpan(0, 0, 0, 0, 0)),
