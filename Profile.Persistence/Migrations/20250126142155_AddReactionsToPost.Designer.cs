...
namespace Profile.Persistence.Migrations
{
    ...
    [Migration("20250126142155_AddReactionsToPost")]
    partial class AddReactionsToPost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Profile.Domain.Entities.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 1, 26, 14, 21, 55, 151, DateTimeKind.Unspecified).AddTicks(2192), new TimeSpan(0, 0, 0, 0, 0)),
