...
namespace Profile.Persistence.Migrations
{
    ...
    [Migration("20250205054101_RemoveOldTable")]
            ...
            modelBuilder.Entity("Profile.Domain.Entities.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 2, 5, 5, 41, 1, 332, DateTimeKind.Unspecified).AddTicks(3700), new TimeSpan(0, 0, 0, 0, 0)),
