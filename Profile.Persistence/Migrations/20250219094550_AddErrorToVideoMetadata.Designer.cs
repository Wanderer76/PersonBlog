...
namespace Profile.Persistence.Migrations
{
    ...
    [Migration("20250219094550_AddErrorToVideoMetadata")]
    partial class AddErrorToVideoMetadata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Profile.Domain.Entities.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 2, 19, 9, 45, 48, 411, DateTimeKind.Unspecified).AddTicks(2360), new TimeSpan(0, 0, 0, 0, 0)),
