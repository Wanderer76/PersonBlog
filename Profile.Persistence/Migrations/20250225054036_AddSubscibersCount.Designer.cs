...
namespace Profile.Persistence.Migrations
{
    ...
    [Migration("20250225054036_AddSubscibersCount")]
    partial class AddSubscibersCount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Profile.Domain.Entities.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 2, 25, 5, 40, 33, 856, DateTimeKind.Unspecified).AddTicks(8473), new TimeSpan(0, 0, 0, 0, 0)),
