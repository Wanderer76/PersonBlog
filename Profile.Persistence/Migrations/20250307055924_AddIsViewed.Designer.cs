...
namespace Profile.Persistence.Migrations
{
    ...
    [Migration("20250307055924_AddIsViewed")]
    partial class AddIsViewed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Profile.Domain.Entities.AppProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 3, 7, 5, 59, 24, 89, DateTimeKind.Unspecified).AddTicks(8819), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Profile.Domain.Entities.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 3, 7, 5, 59, 24, 89, DateTimeKind.Unspecified).AddTicks(9826), new TimeSpan(0, 0, 0, 0, 0)),
