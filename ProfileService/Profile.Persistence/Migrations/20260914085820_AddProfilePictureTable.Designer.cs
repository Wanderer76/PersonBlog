...
namespace VideoReacting.Persistence.Migrations
{
    ...
    [Migration("20260914085820_AddProfilePictureTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Profile.Domain.Entities.ProfilePictureFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ProfilePictureFiles", "Profile");
                });
            ...
            modelBuilder.Entity("Profile.Domain.Entities.ProfilePictureFile", b =>
                {
                    b.HasOne("Profile.Domain.Entities.AppProfile", "AppProfile")
                        .WithOne("ProfilePictureFile")
                        .HasForeignKey("Profile.Domain.Entities.ProfilePictureFile", "ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
