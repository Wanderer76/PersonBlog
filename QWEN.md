...
Личная блогирующая платформа с микросервисной архитектурой на базе .NET 10 и Spring Boot. Поддерживает текстовые посты, видео, музыку, конференции и систему рекомендаций.
