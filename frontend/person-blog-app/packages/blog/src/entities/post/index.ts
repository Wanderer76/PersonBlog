export { default as BigVideoCard } from './ui/BigVideoCard/BigVideoCard';
export { default as SmallVideoCard } from './ui/SmallVideoCard/SmallVideoCard';
...
export { VideoPostCard } from './ui/VideoPostCard/VideoPostCard';
